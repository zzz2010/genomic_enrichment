...
colnames(ret)=c("chipseeker.Ratio","chipseeker.P")
ret
}
...
combine=cbind(r1[o,],r2,r3,r4)
write.table(combine,file=sprintf("reports/%s_%s.report",basename(querybed),key),sep="\t",quote=F)
